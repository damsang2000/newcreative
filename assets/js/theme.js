...
(function ($) {
  ...
  if ($("body").hasClass("tt-transition")) {
    ...
    // Force page a reload when browser "Back" button click (fixes an not loading issue in some browsers).
    // Source: https://stackoverflow.com/questions/8788802/prevent-safari-loading-from-cache-when-back-button-is-clicked/13123626#13123626
    // ======================================================
  ...
  if ($("body").is(".is-mobile").hasClass("tt-magic-cursor")) {
    if ($(window).width() > 1024) {
      $(".magnetic-item").wrap('<div class="magnetic-wrap"></div>');
  ...
  // Append button
  var $tt_demo_btn =
    '<a href="https://1.envato.market/tank" class="tt-demo-btn" target="_blank" rel="noopener"><div class="tt-demo-btn-img"><img src="https://stuff.themetorium.net/img/envato-logo-white.png" alt="Download!"></div><div class="tt-demo-btn-text">Buy This<br> Template!</div></a>';
